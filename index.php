...
================================================== -->
  <body style="font-family:微软雅黑 !important;background-color:#f8f8f8">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel" style="margin-bottom:-200px" >
      <!-- Indicators -->
        ...
        <div class="col-md-4 panelCol">		
		  <div class="panel panel-default panelheadingLeft" style="border-color:#f8f8f8">
            <div class=" panel-heading pannelOpactiy">
			 ...
			 <div class="panel-body standard-vertical-bordered" style="padding: 0px;border-top-width: 0px;border-bottom-width: 0px;">
                  ...
                  <!--<div class="panel-footer" style="margin-top: -10px;">-->
                    <!--<span>-->
                      <!--<a class="hover-blue" style="padding-left: 5px;font-weight: bold;"-->
                         <!--href="http://news.fudan.edu.cn/calendar/">更多活动-->
                        <!--<img src="images/Fudan_home_03.png" style="position: relative;top: -1px;" /></a>-->
                    <!--</span>-->
                  <!--</div>-->
          ...
          <div class="panel panel-default panelheading" style="border-color:#f8f8f8;background-color:#f8f8f8">
           <div class="panelheading panel-heading pannelOpactiy" >
                <!--<i class="fa fa-link"></i>-->              
                 <a href="#"><span class="mytitle" ><b>海关数据</b>
                 <span style="color:#00f">></span></span></a>
           ...
           <div class="panelheading panel-heading pannelOpactiy" >
             ...
             <div class="row" style="margin:15px 0px 0px 2px" id="fudanNews">   
                  <div style="font-size:14px;color:#444;padding:0px;margin-bottom:15px;margin-left:15px;" class="col-xs-10 add-ellipsis">
				    <a style="color:#555" href="http://yarwen.com/fudan/discuss/forum.php?mod=viewthread&tid=2&extra=page%3D1">讨论:&nbsp海关外籍洋员著述列举</a>
				  </div>
				  ...
				  <div style="font-size:14px;color:#444;padding:0px;margin-bottom:15px;margin-left:15px;" class="col-xs-10 add-ellipsis">
				    <a style="color:#555" href="http://yarwen.com/fudan/discuss/forum.php?mod=viewthread&tid=1&extra=page%3D1">话题:&nbsp统计资料使用时需要注意统计单位转换</a>
				  </div>
				   <div style="font-size:10px;padding:0px;margin-left:1px;" class="col-xs-1">
                  ...
                  <div style="font-size:14px;color:#444;padding:0px;margin-bottom:15px;margin-left:15px;" class="col-xs-10 add-ellipsis">
				    <a style="color:#555" href="http://yarwen.com/fudan/discuss/forum.php?mod=viewthread&tid=4&extra=page%3D1">讨论:欢迎大家分享一些数据分析与展示的工具</a>
				  </div>
				   <div style="font-size:10px;padding:0px;margin-left:1px;" class="col-xs-1">
                  ...
                  <div style="font-size:14px;color:#444;padding:0px;margin-bottom:15px;margin-left:15px;" class="col-xs-10 add-ellipsis">
				    <a style="color:#555" href="http://yarwen.com/fudan/discuss/forum.php?mod=viewthread&tid=3&extra=page%3D1">讨论:第二代海关史研究的主要内容是什么？</a>
				  </div>
				   <div style="font-size:10px;padding:0px;margin-left:1px;" class="col-xs-1">
                  ...
                  <div style="font-size:14px;color:#444;padding:0px;margin-bottom:15px;margin-left:15px;" class="col-xs-10 add-ellipsis">
				   <a style="color:#555" href="http://yarwen.com/fudan/discuss/forum.php?mod=viewthread&tid=5&extra=page%3D1">旧海关出版物在世界范围内的收藏情况</a>
				  </div>
				   <div style="font-size:10px;padding:0px;margin-left:1px;" class="col-xs-1">
				    <a style="color:#555" href="#"> <span class="badge" style="background-color:#cc3333;font-size:8px">99</span></a>
				  </div>  
		  ...
		  <!-- <hr style="margin-left:40px;margin-right:40px;height:2px;border:none;border-top:1px dashed" /> -->
		   ...
		   <div class="row" style="margin-left:2px;margin-top:10px">  
            ...
            <!--<div class="list-group">			
              <img src="img/book1.png" alt="..." style="height:146px; widht:180px" class="img-thumbnail">
			  <br>
			  <img src="img/book2.png" alt="..." style="height:146px; widht:180px" class="img-thumbnail">
			  <br>
			  <img src="img/book3.png" alt="..." style="height:146px; widht:180px" class="img-thumbnail">
            </div>-->
          </div>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
				...
				<div id="registry" style="display:none">
				   <form class="bs-example bs-example-form" method="post" action="discuss/discuz_registry_api.php" target="_blank" data-example-id="input-group-sizing">                                      
